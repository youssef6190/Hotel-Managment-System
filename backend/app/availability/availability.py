...
class Availability(MongoBaseModel):
    hotel_id: PydanticObjectId  # ID of the hotel for which availability is being checked
    room_id: PydanticObjectId  # ID of the room for which availability is being checked

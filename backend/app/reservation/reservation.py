...
class Reservation(MongoBaseModel):
    hotel_id: PydanticObjectId  # ID of the hotel being reserved
    user_id: PydanticObjectId  # ID of the user making the reservation
    room_id: PydanticObjectId  # ID of the room being reserved

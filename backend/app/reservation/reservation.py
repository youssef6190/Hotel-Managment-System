...
class Reservation(MongoBaseModel):
    hotel_id: Optional[str]=None  # ID of the hotel being reserved
    user_id:  Optional[str]=None # ID of the user making the reservation
    room_id:  Optional[str]=None # ID of the room being reserved

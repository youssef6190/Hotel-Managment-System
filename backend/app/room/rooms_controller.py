...
from room.room import Room, RoomDocument, TYPE
...
@router.get("/hotel/{hotel_id}", response_model=List[Room])
...
@router.get("/type/{room_type}", response_model=List[Room])
...
@router.get("/search/by-hotel-and-type", response_model=List[Room])
